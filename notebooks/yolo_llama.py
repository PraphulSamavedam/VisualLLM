...
# data = pd.concat([qa_data, captions_data, detections_data], axis=1)
...
# pd.DataFrame(answers).to_csv('10k_default_answers_with_detections.csv', index=False)
...
generation_cfg_answers = [{
    ...
    'Detections': lookup[instance['Image ID']][2],
    'Question': instance['Question'],
    'Prompt': f"Based on the Object detections (generated by YOLOv5): {lookup[instance['Image ID']][2]}, Answer the question: '{instance['Question']}'\n Answer: ",
    'Generated Answer': llamaPipe(f"Based on the Object detections (generated by YOLOv5): {lookup[instance['Image ID']][2]}, Answer the question: '{instance['Question']}'\n Answer: ", max_new_tokens=3)[0]['generated_text']
} for instance in tqdm(results)]

# Write data to a CSV file
pd.DataFrame(generation_cfg_answers).to_csv('10k_generation_cfg_answers_with_detections_no_blip.csv', index=False)
...
generation_cfg_prompt_restriction_answers = [{
    ...
    'Detections' : lookup[instance['Image ID']][2],
    'Question': instance['Question'],
    'Prompt': f"Based on the Object detections (generated by YOLOv5): {lookup[instance['Image ID']][2]}, Answer in a single word the question: '{instance['Question']}'\n Answer: ",
    'Generated Answer': llamaPipe(f"Based on the Object detections (generated by YOLOv5): {lookup[instance['Image ID']][2]}, Answer in a single word the question: '{instance['Question']}'\n Answer: ", max_new_tokens=3)[0]['generated_text']
} for instance in tqdm(results)]

# Write data to a CSV file
pd.DataFrame(generation_cfg_prompt_restriction_answers).to_csv('10k_generation_cfg_prompt_restriction_answers_with_detections_no_blip.csv', index=False)
