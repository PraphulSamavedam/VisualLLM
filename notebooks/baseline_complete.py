...
sample_validation_image_files = validation_image_files[:10000]
...
csv_file_path = '../data/10k_mapped_question_answers.csv'
...
# Define CSV file path
csv_file_path = '10k_blip_captions.csv'
...
# Define CSV file path
csv_file_path = '10k_default_answers.csv'
...
# Define CSV file path
csv_file_path = '10k_generation_cfg_answers.csv'
...
# Define CSV file path
csv_file_path = '10k_generation_cfg_prompt_restriction_answers.csv'
...
# Define CSV file path
csv_file_path = '10k_prompt_with_generation_cfg_answers.csv'
